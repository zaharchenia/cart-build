/*! For license information please see main.1e5b7d05.js.LICENSE.txt */
!(function () {
  "use strict";
  var e = {
      463: function (e, n, t) {
  ...
  !(function () {
    ...
    var d = function (n) {
      ...
      m = function (e) {
        ...
        return (0, r.jsxs)("footer", {
          ...
          children: [
            (0, r.jsxs)("div", {
              className: "cart-footer__count",
              children: [t, " \u0435\u0434."],
            }),
            (0, r.jsxs)("div", {
              className: "cart-footer__price",
              children: [l.toLocaleString(), " \u0440\u0443\u0431."],
            }),
          ],
        });
      },
      ...
      v = function (n) {
        var t = n.id,
          l = (0, e.useContext)(k).deleteProduct;
        return (0, r.jsx)("button", {
          onClick: function () {
            l(t);
          },
        ...
        return (0, r.jsxs)("section", {
          ...
          children: [
            (0, r.jsx)("div", {
              ...
              children: (0, r.jsx)("img", {
                src: "./img/products/".concat(t),
                alt: l,
              }),
            }),
            (0, r.jsx)("div", { className: "product__title", children: l }),
            (0, r.jsx)("div", {
              className: "product__count",
              children: (0, r.jsx)(g, { count: o, id: u }),
            }),
            (0, r.jsxs)("div", {
              className: "product__price",
              children: [p.format(a), "\u0440\u0443\u0431."],
            }),
            (0, r.jsx)("div", {
              className: "product__controls",
              children: (0, r.jsx)(v, { id: u }),
            }),
          ],
        });
      },
      b = "https://occipital-clever-olivine.glitch.me/",
      k = (0, e.createContext)(null),
      w = function () {
        ...
        (0, e.useEffect)(
          ...
          (0, e.useEffect)(
            function () {
              t &&
                u({
                  price: t.reduce(function (e, n) {
                    return e + n.priceTotal;
                  }, 0),
                  count: t.reduce(function (e, n) {
                    return e + n.count;
                  }, 0),
                });
            },
          ...
          value: {
            deleteProduct: function (e) {
              l(function (n) {
                ...
                fetch(b + "products/" + e, { method: "DELETE" }).then(function (
                  e
                ) {
                  e.ok &&
                    p(function (e) {
            ...
            increase: function (e) {
              var n = t.find(function (n) {
                ...
                r = s(
                  s({}, n),
                  {},
                  { count: ++n.count, priceTotal: n.count * n.price }
                );
              fetch(b + "products/" + e, {
                method: "PUT",
            ...
            decrease: function (e) {
              var n = t.find(function (n) {
                ...
                r = n.count - 1 > 1 ? n.count - 1 : 1,
                l = s(s({}, n), {}, { count: r, priceTotal: r * n.price });
              fetch(b + "products/" + e, {
                method: "PUT",
                headers: { "Content-Type": "application/json" },
            ...
            changeValue: function (e, n) {
              var r = t.find(function (n) {
                ...
                l = s(s({}, r), {}, { count: n, priceTotal: n * r.price });
              fetch(b + "products/" + e, {
                method: "PUT",
                headers: { "Content-Type": "application/json" },
                body: JSON.stringify(l),
            ...
            addProduct: function () {
              var e = function (e) {
                ...
                n = e([1e5, 29e3, 19e4]),
                t = {
                  img: e(["mac-book.jpg", "apple-watch.jpg", "mac-pro.jpg"]),
                  title: e(["Apple MacBook Air 13", "Apple watch", "Mac Pro"]),
                  count: 1,
                  price: n,
                  priceTotal: n,
                };
          ...
          children: [
            (0, r.jsxs)("section", {
              ...
              children: [
                ...
                t &&
                  t.map(function (e) {
                    return (0, r.jsx)(y, { product: e }, e.id);
                  }),
                o && (0, r.jsx)(m, { total: o }),
              ],
            }),
            (0, r.jsx)("section", {
              className: "button-add-wrapper",
              children: (0, r.jsx)(d, { title: "Add product" }),
            }),
          ],
        });
      };
    ...
    n.createRoot(document.getElementById("root")).render((0, r.jsx)(S, {}));
  })();
})();
//# sourceMappingURL=main.1e5b7d05.js.map
